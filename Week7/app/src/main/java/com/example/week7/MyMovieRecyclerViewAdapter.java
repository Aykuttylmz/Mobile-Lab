...
import com.example.week7.placeholder.PlaceholderContent.PlaceholderItem;
import com.example.week7.databinding.FragmentMovieBinding;
...
public class MyMovieRecyclerViewAdapter extends RecyclerView.Adapter<MyMovieRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mIdView.setText(Integer.toString(position));//index
        holder.mContentView.setText(mValues.get(position).getName()); //film name
        ...
        }); holder.itemView.setBackgroundColor(selectedIndex == position ?
